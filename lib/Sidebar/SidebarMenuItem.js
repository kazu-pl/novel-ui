...
var SidebarMenuItem = function (props) {
    ...
    return props.variant === "with-dropdown" ? (jsxs(Fragment, { children: [jsxs(StyledListItemButton, __assign({ onClick: handleClick }, { children: [jsx(StyledListItemIcon, { children: props.icon }, void 0), jsx(StyledListItemText, { primary: props.label, color: "#ffffff" }, void 0), isSubmenuOpen ? (jsx(ColoredIconWrapper, __assign({ color: "grey" }, { children: jsx(ExpandLess, {}, void 0) }), void 0)) : (jsx(ColoredIconWrapper, __assign({ color: "grey" }, { children: jsx(ExpandMore, {}, void 0) }), void 0))] }), void 0), jsx(Collapse
