...
function EnhancedTable(_a) {
    ...
    return (jsx(Box, __assign({ sx: { width: "100%" } }, { children: jsxs(Paper, __assign({ sx: { width: "100%", mb: 2 } }, { children: [jsxs(Toolbar, __assign({ sx: __assign({ pl: { sm: 2 }, pr: { xs: 1, sm: 1 } }, (selectedItemsIndexes.length > 0 && {
                        bgcolor: function (theme) {
                    ...
                    })) }, { children: [selectedItemsIndexes.length > 0 ? (jsx(Typography, __assign({ sx: { flex: "1 1 100%" } }, { children: " " + selectedItemsIndexes.length + " " + selectedItemsText }), void 0)) : (jsx(Typography, __assign({ sx: { flex: "1 1 100%" }, variant: "h6" }, { children: tableName }), void 0)), selectedItemsIndexes.length > 0 &&
                            ...
                            iconsToManageSelectedData(data.filter(function (_, index) { return selectedItemsIndexes.includes(index); })), selectedItemsIndexes.length === 0 && filters && (jsx(IconButton, __assign({ onClick: filters
                                ...
                                : undefined }, { children: jsx(FilterListIcon, {}, void 0) }), void 0))] }), void 0), filters && isFiltersBarVisible && jsx(Box, __assign({ p: 2 }, { children: filters }), void 0), jsx(TableContainer, { children: jsxs(Table, __assign({ sx: { minWidth: 750 }, size: "medium" }, { children: [jsx(TableHead, { children: jsxs(TableRow, { children: [isSelectable && (jsx(TableCell, __assign({ padding: "checkbox" }, { children: jsx(Checkbox, { color: "primary", indeterminate: selectedItemsIndexes.length > 0 &&
                                                ...
                                                } }, void 0) }), void 0)), visibleColumns.map(function (column, columnIndex) { return (jsx(TableCell, __assign({ sortDirection: (sort === null || sort === void 0 ? void 0 : sort.sortBy) === column.key ? sort === null || sort === void 0 ? void 0 : sort.sortDirection : false }, { children: column.isSortable ? (jsx(Fragment, { children: jsx(TableSortLabel, __assign({ active: (sort === null || sort === void 0 ? void 0 : sort.sortBy) === column.key, direction: (sort === null || sort === void 0 ? void 0 : sort.sortBy) === column.key
                                        ...
                                        return (jsxs(TableRow, __assign({ hover: true, tabIndex: -1, selected: isItemSelected }, { children: [isSelectable && (jsx(TableCell, __assign({ padding: "checkbox" }, { children: jsx(Checkbox, { color: "primary", checked: isItemSelected, inputProps: {
                                                ...
                                                : visibleColumns.length, align: "center" }, { children: noDataText }), void 0) }, void 0))] }, void 0)] }), void 0) }, void 0), pagination && (jsx(TablePagination, { rowsPerPageOptions: rowsPerPageOptions, component: "div", count: pagination.totalItems, rowsPerPage: pagination.pageSize, page: pagination.currentPage - 1, onPageChange: function (event, page) { return onChangePage(page + 1); }, onRowsPerPageChange: handleChangeRowsPerPage, labelRowsPerPage: rowsPerPageText }, void 0))] }), void 0) }), void 0));
}
