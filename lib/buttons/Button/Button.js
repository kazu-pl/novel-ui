...
var Button = forwardRef(function (_a, ref) {
    ...
    return (jsxs(StyledWrapper, __assign({ fullWidth: fullWidth }, { children: [jsx(StyledButton, __assign({ fullWidth: fullWidth, disabled: isPromiseLoading || isLoading || disabled, color: color, size: size, ref: ref, target: target, onClick: handleBtnClick, component: to ? Link : component || undefined, to: to, "$textTransform": textTransform }, rest), void 0), (isPromiseLoading || isLoading) && (jsx(CircularProgress, { color: color, size: size === "large" ? 20 : size === "medium" ? 18 : 16 }, void 0))] }), void 0));
});
