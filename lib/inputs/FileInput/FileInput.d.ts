...
import { ExtendedFile } from "./SingleFile";
...
declare const FileInput: ({ id, inputRef, text, buttonProps, helperText, error, onDeleteIconClick, value, ...rest }: FileInputProps) => JSX.Element;
