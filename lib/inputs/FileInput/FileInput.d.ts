...
import { SingleFileProps, ExtendedFile } from "./SingleFile";
/**
 * @todo
 *
...
declare const FileInput: ({ id, inputRef, text, buttonProps, helperText, error, onDeleteIconClick, onPreviewFileIconClick, value, ...rest }: FileInputProps) => JSX.Element;
