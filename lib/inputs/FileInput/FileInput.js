...
var FileInput = function (_a) {
    ...
    } : _b, helperText = _a.helperText, error = _a.error, onDeleteIconClick = _a.onDeleteIconClick, value = _a.value, rest = __rest(_a, ["id", "inputRef", "text", "buttonProps", "helperText", "error", "onDeleteIconClick", "value"]);
    return (jsxs("div", { children: [jsx("input", __assign({ id: id, type: "file", hidden: true, ref: inputRef }, rest), void 0), jsx(InputLabel, __assign({ htmlFor: id }, { children: jsx(Button, __assign({ component: "span" }, buttonProps, { children: text }), void 0) }), void 0), helperText && (jsx(FormHelperText, __assign({ sx: __assign({}, (error && { color: function (theme) { return theme.palette.error.main; } })) }, { children: helperText }), void 0)), Array.isArray(value) &&
                value.map(function (file) { return (jsx(SingleFile, { onDeleteIconClick: onDeleteIconClick, file: file }, file.id)); }), !Array.isArray(value) && value && (jsx(SingleFile, { onDeleteIconClick: onDeleteIconClick, file: value }, void 0))] }, void 0));
};
