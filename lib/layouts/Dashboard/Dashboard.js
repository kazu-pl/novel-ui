...
var Dashboard = function (_a) {
    var appBarProps = _a.appBarProps, _b = _a.sidebarProps, SIDEBAR_WIDTH = _b.width, restOfSidebarProps = __rest(_b, ["width"]), bgColor = _a.bgColor, children = _a.children, title = _a.title, additionalControls = _a.additionalControls;
    var additionalAppBarControls = appBarProps.additionalControls, restOfAppBarProps = __rest(appBarProps, ["additionalControls"]);
    var _c = useState(false), isSidebarOpenOnMobile = _c[0], setIsSidebarOpenOnMobile = _c[1];
