import { _ as __makeTemplateObject, c as __rest, a as __assign } from '../../tslib.es6-45043e13.js';
...
var Modal = function (_a) {
    var _b = _a.open, open = _b === void 0 ? false : _b, onClose = _a.onClose, children = _a.children, headlineText = _a.headlineText, footerContent = _a.footerContent, headlineTextColor = _a.headlineTextColor, rest = __rest(_a, ["open", "onClose", "children", "headlineText", "footerContent", "headlineTextColor"]);
    return (jsx(MuiModal, __assign({ open: open, onClose: onClose }, rest, { children: jsxs(StyledModalBody, { children: [headlineText && (jsx(StyledTitleWrapper, __assign({ color: headlineTextColor }, { children: jsx(Typography, __assign({ variant: "h6", color: headlineTextColor === "black" ? "textPrimary" : "inherit" }, { children: headlineText }), void 0) }), void 0)), children, footerContent && (jsx(Box, __assign({ display: "flex", justifyContent: "flex-end", mt: 4 }, { children: footerContent }), void 0))] }, void 0) }), void 0));
};
